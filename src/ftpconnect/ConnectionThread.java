...
public class ConnectionThread extends SwingWorker<Void, Void> {
	...
	protected void done() {
		if (ConnectHost.hostConnected) {
			...
			JOptionPane.showMessageDialog(ClientMainFrame.frame, "Successfully logged in to the server",
					"Status: Connected", JOptionPane.OK_OPTION, new ImageIcon("res\\check_icon.png"));
		}
	}
}